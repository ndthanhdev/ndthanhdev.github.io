...
type CommonHeadersQueryVariables = Exact<{ [key: string]: never; }>;


type CommonHeadersQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null } | null } | null };
